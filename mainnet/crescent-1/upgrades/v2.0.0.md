...
Please be patient that this may take from 20 minutes to a few hours. The chain will continue to produce blocks when validators with a total sum voting power > 2/3 complete their nodes upgrades.
