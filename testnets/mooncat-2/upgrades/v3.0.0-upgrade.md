# mooncat-2, v3.0.0 Upgrade, Instructions
...
```
ERR UPGRADE "v3.0.0" NEEDED at height: 30

ERR CONSENSUS FAILURE!!! err="UPGRADE "v3.0.0" NEEDED at height: 30

```

Stop the node, and install [Crescent v3.0.0-rc3](https://github.com/crescent-network/crescent/releases/tag/v3.0.0-rc3) and re-start by `crescentd start --halt-height 30` for next upgrade.
...
```
ERR UPGRADE "v3.0.0" NEEDED at height: 30: upgrade to v3.0.0 and applying upgrade "v3.0.0" at height:30.
...
> crescentd start --unsafe-skip-upgrade 30
>
