# mooncat-2, farming-migration(v3-early) Upgrade, Instructions

This document describes the steps for validator and full node operators for the successful execution of the `farming-migration(v3-early)`

Proposal 22

Chain ID : mooncat-2

Upgrade Name : ****farming-migration(v3-early)****

Upgrade Height : 3126350

Binary : Crescent [v2.3.0](https://github.com/crescent-network/crescent/releases/tag/v2.3.0) -> [farming-migration(v3-early)](https://github.com/crescent-network/crescent/tree/farming-migration)
...
### Target runtime, mooncat-2 (post v3.0.0 upgrade) will run Crescent farming-migration(v3-early)

The Crescent testnet network, `mooncat-2`, will run [Crescent farming-migration(v3-early)](https://github.com/crescent-network/crescent/tree/farming-migration) Operators *MUST* use this version post-upgrade to remain connected to the network.
...
Stop the node, and install [Crescent farming-migration(v3-early)](https://github.com/crescent-network/crescent/tree/farming-migration) and re-start by `crescentd start --halt-height 3126350` for next upgrade.
...
### Method II: upgrade using Cosmovisor by manually preparing the Crescent farming-migration(v3-early) binary
...
build Crescent farming-migration(v3-early), and move crescentd farming-migration(v3-early) to `$CRESCENT_HOME/cosmovisor/upgrades/v3.0.0/bin`

```bash
export CRESCENT_UPGRADE_PATH={SET_YOUR_PATH}
$CRESCENT_UPGRADE_PATH version
# should be farming-migration(v3-early)
