# mooncat-2-3, v3.0.0-rc7 Upgrade, Instructions

This document describes the steps for validator and full node operators for the successful execution of the `v3.0.0-rc7`

Proposal 22

Chain ID : mooncat-2-3

Upgrade Name : ****v3.0.0-rc7****

Upgrade Height : 3494650

Binary : Crescent [v2.3.0](https://github.com/crescent-network/crescent/releases/tag/v2.3.0) -> [v3.0.0-rc7)](https://github.com/crescent-network/crescent/releases/tag/v3.0.0-rc7)
...
### Target runtime, mooncat-2-3 (post v3.0.0 upgrade) will run Crescent v3.0.0-rc7

The Crescent testnet network, `mooncat-2-3`, will run [v3.0.0-rc7](https://github.com/crescent-network/crescent/releases/tag/v3.0.0-rc7) Operators *MUST* use this version post-upgrade to remain connected to the network.
...
```
ERR UPGRADE "v3.0.0" NEEDED at height: 3494650

ERR CONSENSUS FAILURE!!! err="UPGRADE "v3.0.0" NEEDED at height: 3494650

```

Stop the node, and install [v3.0.0-rc7](https://github.com/crescent-network/crescent/releases/tag/v3.0.0-rc7) and re-start by `crescentd start --halt-height 3494650` for next upgrade.
...
### Method II: upgrade using Cosmovisor by manually preparing the Crescent v3.0.0-rc7 binary
...
build Crescent v3.0.0-rc7, and move crescentd v3.0.0-rc7 to `$CRESCENT_HOME/cosmovisor/upgrades/v3.0.0/bin`

```bash
export CRESCENT_UPGRADE_PATH={SET_YOUR_PATH}
$CRESCENT_UPGRADE_PATH version
# should be v3.0.0-rc7
...
```
ERR UPGRADE "v3.0.0" NEEDED at height: 30: upgrade to v3.0.0 and applying upgrade "v3.0.0" at height: 3494650.
...
> crescentd start --unsafe-skip-upgrade 3494650
>
